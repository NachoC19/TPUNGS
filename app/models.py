...
class Favourite(models.Model):
    ...
    poke_id = models.IntegerField()  #usar id como primary key generaba problemas a la hora de aniadir el mismo pokemon en distintos usuarios y se cambio la logica
